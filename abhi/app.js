(function() {
    ...
    var defaults = {
      ...
      cssUrl: 'https://dasmeet9.github.io/model/ai_agent/style.css'  // The URL to the external CSS fil
    };
    ...
    function createWidgetHTML(container, config) {
      container.innerHTML = `<div id="chatbot-container">
      <link rel="stylesheet" href="https://dasmeet9.github.io/model/ai_agent/style.css">
...
<!-- <div class='main' > -->
    ...
    <button class="yarra-ai-close-btn" id="close-btn23">
        ...
        <svg width="15" height="15" style="background-color: #4f4e4e69;border-radius: 8px 8px 8px 8px;padding: 0;width: 30px;height: 20px; " viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="bootm" style="display: flex; width:100%; height:100%; ">
            <div class="l">
                ...
                <div id="avatar-name">
                    ...
                    <div class="stlp"><span>Powered by &nbsp;</span><a href="https://aiagent.yaraai.com/" target="_blank">Yaraa.ai</a></div>
                </div>
            </div>
            <div class="r" >
                    ...
                    <form id="text-form">
                       ...
                       <textarea id="text" rows="2" placeholder="Type your message here..."></textarea>
                            <div id="speech-to-text-container" class="tooltip-container">
                                <button type="button" id="speech-to-text-control" class="control-btn speech-to-text-btn" title="Speech to Text">
                                    <svg class="btn-icon" viewBox="0 0 36 24">
                                        ...
                                        <rect id="rect1" x="2" y="9" width="4.5" height="6" rx="2" stroke="#2A3663" stroke-width="0" fill="#a0a8ff"/>
                                        <rect id="rect2" x="8.5" y="5" width="4.5" height="14" rx="2" stroke="#2A3663" stroke-width="0" fill="#b28aff"/>
                                        <rect id="rect3" x="15" y="3" width="4.5" height="18" rx="2" stroke="#2A3663" stroke-width="0" fill="#c372ff"/>
                                        <rect id="rect4" x="21.5" y="5" width="4.5" height="14" rx="2" stroke="#2A3663" stroke-width="0" fill="#b28aff"/>
                                        <rect id="rect5" x="28" y="9" width="4.5" height="6" rx="2" stroke="#2A3663" stroke-width="0" fill="#a0a8ff"/>
                                    </svg>
                                </button>
                        ...
                        <div class="form-belowline">
                            ...
                            <button type="button" id="end-chat" class="control-btn end-chat-btn" title="End Chat" style="display: none;" >
                           ...
                           <button type="submit" class="control-btn send-btn" title="Send Message">
                                ...
                                <button type="button" id="mic-control" class="control-btn mic-control-btn" title="Voice Input" style="display: none;">
                                    <svg class="btn-icon" viewBox="0 0 24 24">
...
// const closeButton = document.querySelector("#end-chat");
...
const endChatIcon = document.getElementById("close-btn23");
// const endChatIcon = document.getElementById("close-btn23");
...
const inputbar = document.getElementById('text');
let sttanimation = false;
let sttloader = document.getElementsByClassName('loader-dots');
...
const INITIAL_SPEECH_TIMEOUT = 10000; // 10s to start speaking ✅
...
const INITIAL_TIMEOUT = 10000; // 10s to start speaking
...
let silenceTimeout = 2000; // 2seconds
...
function processRecordedAudio() {
    ...
    .then(data => {
        ...
        if (data.success && data.text) {
            ...
            console.error("Error processing audio:", data.error || "Unknown error");
...
// Add helper function to start microphone after the answer is complete
...
function stripHtmlTags(html) {
    ...
    // Ensure each sentence appears on a new line when separated by a capital letter
...
//                     cancelAnimationFrame(speechDetectionFrameId); // 👈 Cancel further checks
...
//         if (!startedSpeaking) {
//             speechDetectionFrameId = requestAnimationFrame(checkSpeechStart); // 👈 Track the ID
//         }
//     }

//     // Before starting new detection, cancel any previous one
//     if (speechDetectionFrameId) {
//         cancelAnimationFrame(speechDetectionFrameId);
//         speechDetectionFrameId = null;
//     }

//     checkSpeechStart(); // Start detection loop
// }
...
function detectSilence() {
    ...
    const checkSilence = () => {
        ...
        const volume = Math.abs(maxVolume - 128); // 128 is silence
...
async function showThankYouMessage() {
    ...
    setTimeout(() => {
        closechat();
        document.getElementsByClassName('thank-you-container')[0].remove();
    }, 2000);
}
...
function initAudioPreferences() {
    if (MICONLY) {
        ...
        if (savedPreferences) {
            const { isMuted ,microphoneEnabled } = JSON.parse(savedPreferences);
...
ChatbotWidget.init({
       ...
       cssUrl: 'https://dasmeet9.github.io/model/ai_agent/style.css'
});
